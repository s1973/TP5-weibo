...
<head>
    ...
    <?php 
     ...
     ?>
	<title><?php echo \think\Config::get('system.WEBNAME'); ?>-我的评论</title>
	<link rel="stylesheet" href="__STATIC__/Theme/<?php echo $style; ?>/Css/nav.css" />
	<link rel="stylesheet" href="__STATIC__/Theme/<?php echo $style; ?>/Css/comment.css" />
    ...
    <script type='text/javascript' src='__STATIC__/Js/comment.js'></script>
    <script type="text/javascript">
        var replyUrl = "<?php echo url('reply'); ?>";
        var delComment = "<?php echo url('delComment'); ?>";
    </script>
<script type='text/javascript'>
