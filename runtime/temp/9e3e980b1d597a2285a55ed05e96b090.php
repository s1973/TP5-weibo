<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:72:"E:\htdoc\ThinkPHP5\public/../application/index\view\user\followList.html";i:1507707147;s:70:"E:\htdoc\ThinkPHP5\public/../application/index\view\Common\header.html";i:1506406829;s:67:"E:\htdoc\ThinkPHP5\public/../application/index\view\Common\nav.html";i:1507605447;s:68:"E:\htdoc\ThinkPHP5\public/../application/index\view\Common\left.html";i:1507710017;s:70:"E:\htdoc\ThinkPHP5\public/../application/index\view\Common\bottom.html";i:1506395608;}*/ ?>
...
<head>
    ...
    <?php 
     ...
     ?>
	<title><?php echo \think\Config::get('system.WEBNAME'); ?>-关注列表页</title>
	<link rel="stylesheet" href="__STATIC__/Theme/<?php echo $style; ?>/Css/nav.css" />
	<link rel="stylesheet" href="__STATIC__/Theme/<?php echo $style; ?>/Css/list.css" />
...
<!--==========内容主体==========-->
    ...
    <!--=====右侧=====-->
    	<div id='right'>
    		...
    		<ul>
            <?php if(is_array($users) || $users instanceof \think\Collection || $users instanceof \think\Paginator): if( count($users)==0 ) : echo "" ;else: foreach($users as $key=>$v): ?>
    			<li>
					<dl class='list-left'>
						<dt>
							<img src="<?php if($v["face"]): ?>__ROOT__/Uploads/Face/<?php echo $v['face']; else: ?>__STATIC__/Images/noface.gif<?php endif; ?>" width='50' height='50'/>
						</dt>
						<dd>
						...
						<dd>
							<span>关注 <a href="<?php echo url('follow/' . $v['uid']); ?>"><?php echo $v['follow']; ?></a></span>
							<span class='bd-l'>粉丝 <a href="<?php echo url('fans/' . $v['uid']); ?>"><?php echo $v['fans']; ?></a></span>
							<span class='bd-l'>微博 <a href="<?php echo url('/' . $v['uid']); ?>"><?php echo $v['weibo']; ?></a></span>
						</dd>
					</dl>
    				<dl class='list-right'>
    					<?php if(in_array($v["uid"], $follow) && in_array($v["uid"], $fans)): ?>
                            <dt>互相关注</dt>
