<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"E:\htdoc\ThinkPHP5\public/../application/index\view\user\index.html";i:1507619620;s:70:"E:\htdoc\ThinkPHP5\public/../application/index\view\Common\header.html";i:1506406829;s:67:"E:\htdoc\ThinkPHP5\public/../application/index\view\Common\nav.html";i:1507605447;s:70:"E:\htdoc\ThinkPHP5\public/../application/index\view\Common\bottom.html";i:1506395608;}*/ ?>
...
<head>
    ...
    <?php 
     ...
     ?>
	<title><?php echo \think\Config::get('system.WEBNAME'); ?>-用户个人页</title>
	<link rel="stylesheet" href="__STATIC__/Theme/<?php echo $style; ?>/Css/nav.css" />
	<link rel="stylesheet" href="__STATIC__/Theme/<?php echo $style; ?>/Css/user.css" />
...
<!--==========内容主体==========-->
	...
	<div id='userinfo'>
		<div class='info-list'>
			<div class='info-face'>
				<p>
					<img src="<?php if($userinfo["face180"]): ?>__ROOT__/Uploads/Face/<?php echo $userinfo['face180']; else: ?>__STATIC__/Images/noface.gif<?php endif; ?>" width='180' height='180' alt="<?php echo $userinfo['username']; ?>" />
				</p>
				<ul>
					<li>
						<a href="<?php echo url('follow/' . $userinfo['uid']); ?>">
							<strong><?php echo $userinfo['follow']; ?></strong><br/>关注
						</a>
					</li>
					<li>
						<a href="<?php echo url('fans/' . $userinfo['uid']); ?>">
							<strong><?php echo $userinfo['fans']; ?></strong><br/>粉丝
						</a>
					</li>
					<li>
						<a href="<?php echo url('/' . $userinfo['uid']); ?>">
            ...
            <?php if(session("?uid") && session("uid") == input("id")): ?>
				<li class='uedit full'>
					<a href="<?php echo url('UserSetting/index'); ?>">修改个人资料</a>
				</li>
            <?php endif; ?>
			</ul>
		</div>
        ...
        <?php if(session("?uid") && session("uid") == input("id")): ?>
            <div class='send_wrap'>
                ...
                <div class='send_write'>
                    <form action='<?php echo url("Index/sendWeibo"); ?>' method='post' name='weibo'>
...
<!--====================转发样式结束====================-->
        ...
        <div id='right'>
        	<dl>
                ...
                <?php if(is_array($follow) || $follow instanceof \think\Collection || $follow instanceof \think\Paginator): if( count($follow)==0 ) : echo "" ;else: foreach($follow as $key=>$v): ?>
        		<dd>
        			<a href="<?php echo url('/' . $v['uid']); ?>">
        				<img src="<?php if($v["face"]): ?>__ROOT__/Uploads/Face/<?php echo $v['face']; else: ?>__STATIC__/Images/noface.gif<?php endif; ?>" alt="<?php echo $v['username']; ?>" width='50' height='50'/>
        			</a>
        			<p>
        				<a href="<?php echo url('/' . $v['uid']); ?>"><?php echo $v['username']; ?></a>
        			</p>
        	...
        	<dl>
                ...
                <?php if(is_array($fans) || $fans instanceof \think\Collection || $fans instanceof \think\Paginator): if( count($fans)==0 ) : echo "" ;else: foreach($fans as $key=>$v): ?>
        		<dd>
        			<a href="<?php echo url('/' . $v['uid']); ?>">
        				<img src="<?php if($v["face"]): ?>__ROOT__/Uploads/Face/<?php echo $v['face']; else: ?>__STATIC__/Images/noface.gif<?php endif; ?>" alt="<?php echo $v['username']; ?>" width='50' height='50'/>
        			</a>
