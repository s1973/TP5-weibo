<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"E:\htdoc\ThinkPHP5\public/../application/index\view\user_setting\index.html";i:1507607292;s:70:"E:\htdoc\ThinkPHP5\public/../application/index\view\Common\header.html";i:1506406829;s:67:"E:\htdoc\ThinkPHP5\public/../application/index\view\Common\nav.html";i:1507605447;s:68:"E:\htdoc\ThinkPHP5\public/../application/index\view\Common\left.html";i:1507605396;}*/ ?>
...
<head>
    ...
    <?php 
     ...
     ?>
	<title><?php echo \think\Config::get('system.WEBNAME'); ?>-修改个人资料</title>
	<link rel="stylesheet" href="__STATIC__/Theme/<?php echo $style; ?>/Css/nav.css" />
	<link rel="stylesheet" href="__STATIC__/Theme/<?php echo $style; ?>/Css/edit.css" />
	...
	<script type='text/javascript' src='__STATIC__/Js/edit.js'></script>
    ...
    <script type='text/javascript'>
        ...
        var uploadUrl = '<?php echo url("Common/uploadFace"); ?>';
...
<!--==========内容主体==========-->
    ...
    <!--=====右侧=====-->
    	<div id='right'>
    		...
    		<div class='form'>
    			<form action="<?php echo url('editBasic'); ?>" method='post'>
    				<p>
    		...
    		<div class='form hidden'>
    			<form action="<?php echo url('editFace'); ?>" method='post'>
	    			<div class='edit-face'>
	    				<img src="
                        <?php if($user["face180"]): ?>
                            __ROOT__/Uploads/Face/<?php echo $user['face180']; else: ?>
                            __STATIC__/Images/noface.gif
                        <?php endif; ?>" width='180' height='180' id='face-img'/>
	    				<p>
    		...
    		<div class='form hidden'>
    			<form action="<?php echo url('editPwd'); ?>" method='post' name='editPwd'>
