<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:68:"E:\htdoc\ThinkPHP5\public/../application/index\view\user\letter.html";i:1507709581;s:70:"E:\htdoc\ThinkPHP5\public/../application/index\view\Common\header.html";i:1506406829;s:67:"E:\htdoc\ThinkPHP5\public/../application/index\view\Common\nav.html";i:1507605447;s:68:"E:\htdoc\ThinkPHP5\public/../application/index\view\Common\left.html";i:1507710017;s:69:"E:\htdoc\ThinkPHP5\public/../application/index\view\Common\right.html";i:1506404582;s:70:"E:\htdoc\ThinkPHP5\public/../application/index\view\Common\bottom.html";i:1506395608;}*/ ?>
...
<head>
    ...
    <?php 
     ...
     ?>
	<title><?php echo \think\Config::get('system.WEBNAME'); ?>-我的私信</title>
	<link rel="stylesheet" href="__STATIC__/Theme/<?php echo $style; ?>/Css/nav.css" />
	<link rel="stylesheet" href="__STATIC__/Theme/<?php echo $style; ?>/Css/letter.css" />
    ...
    <script type='text/javascript' src='__STATIC__/Js/letter.js'></script>
    <script type="text/javascript">
        var delLetter = "<?php echo url('delLetter'); ?>";
    </script>
<script type='text/javascript'>
...
<div style='height:60px;opcity:10'></div>
    ...
    <!--=====中部=====-->
        ...
        <?php if(is_array($letter) || $letter instanceof \think\Collection || $letter instanceof \think\Paginator): if( count($letter)==0 ) : echo "" ;else: foreach($letter as $key=>$v): ?>
			<dl>
				<dt>
					<a href="<?php echo url('/' . $v['uid']); ?>"><img src="<?php if($v["face"]): ?>__ROOT__/Uploads/Face/<?php echo $v['face']; else: ?>__STATIC__/Images/noface.gif<?php endif; ?>" width='50' height='50'/></a>
				</dt>
				<dd>
...
<!--私信弹出框-->
<div id='letter'>
    <form action='<?php echo url("letterSend"); ?>' method='post'>
