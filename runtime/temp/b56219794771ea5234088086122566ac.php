<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"E:\htdoc\ThinkPHP5\public/../application/index\view\login\index.html";i:1506477076;}*/ ?>
...
<head>
	...
	<title><?php echo \think\Config::get('system.WEBNAME'); ?>-登录</title>
	<link rel="stylesheet" href="__STATIC__/Css/login.css" />
	<js file='__STATIC__/Js/jquery-1.7.2.min.js'/>
	<js file='__STATIC__/Js/jquery-validate.js'/>
	<js file='__STATIC__/Js/login.js'/>
</head>
<body>
	<div id='top-bg'></div>
	<div id='login-form'>
		<div id='login-wrap'>
			<p>还没有微博帐号？<a href='<?php echo url("register"); ?>'>立即注册</a></p>
